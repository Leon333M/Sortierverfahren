...
\newcommand{\EinflussDesListentypsAnalyse}{
    ...
    Im Digram ist ebenfals zu erkenen das der Worstcase von qiksort eine Lauziet von O(n^2) hat. Alerdings endet der grph ab 20k da schon bei 40k ein stackoverlow duch die rekusinstife ausgelöst wird. Dies ist aber in einer iterative verion von Qiksort nicht mer der fall.
}
