...
\newcommand{\WorkerthreadsErwartung}{
    ...
    Dis ligt an den Wait und wird nur duch addTaskSmart Compensirt indem die funkten dfür sorgt das imer midestes die hälte aller thads ausgelaset bleiben werden.
    \newline
