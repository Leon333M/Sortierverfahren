...
\newcommand{\EinflussDesListentypsAnalyse}{
    ...
    Im Diagramm ist ebenfalls zu erkennen, dass der Worst Case von Quicksort eine Laufzeit von \(O(n^2)\) hat. Allerdings endet der Graph ab 20k, da bereits bei 40k ein Stackoverflow durch die Rekursionstiefe ausgelöst wird. Dies ließe sich durch eine iterative Version von Quicksort vermeiden.
}
