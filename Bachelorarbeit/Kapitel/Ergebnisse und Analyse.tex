...
\newcommand{\EinflussDesListentypsMessziel}{
    Der lsiten typ ist relvant da es bei qiksort einen bestcase sowie worst cashe gibt. Dise hängen auschlisel von den inhlat der zur sorteenden lsite abe und somit acuh vom listen typ. Gleichzeitig dient die mesung der volstädich keit damit man die laufzeit auch mit nicht von mir verlgichen Sorteralgorimen gut verglechbar sind.
}
% \subsection{Erwartung}
