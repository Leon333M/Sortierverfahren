...
\newcommand{\WorkerthreadsErwartung}{
    ...
    Dies liegt an dem Wait und wird nur durch \texttt{addTaskSmart} kompensiert (Listing \ref{lst:mergesortW}), indem die Funktion dafür sorgt, dass immer mindestens die Hälfte aller Threads ausgelastet bleiben.
    \newline
