...
\newcommand{\TiefenbasierteThreadErzeugungAnalyse}{
    ...
    Dies ist auch deutlich im Strong Scaling zu erkennen: Dort sieht man, dass Quicksort bei dieser Liste weiterhin an Performance gewinnt, obwohl die Threadanzahl die Anzahl der logischen Prozessoren übersteigt. Wohingegen man bei Mergesort sieht, dass es nur leicht schlechter als die theoretisch zu erwartende Laufzeitverbesserung ist.
    \newline
