...
\newcommand{\EinflussDesDatentypsAnalyse}{
    ...
    Ganz bedors fält auf das Mergesort beim Strong Scaling (Abbildung~\ref{fig:EinflussDesDatentypsDiagrammB}) schon noch 8 tahds nur noich eine minimale pervomce verungeung erzihlt.
    Dies ligt an dem genanten kopern welches warschilch dazu führ das der cashe vollöuft und simt cashmises entshen,
    Dsie sorgen dann wider für erhöte speicherlatzen.
