...
\newcommand{\TiefenbasierteThreadErzeugungAnalyse}{
    ...
    \newline
    Die starken Lauziet schwakungen von Quicksort bei verschidenen lsiten sind auf die unglecihe lastverteiung auf die Thrads zurückzuführn.
    Bei diser Quicksort variante wir ddie thradf last unglecih meistens inglech verteilt, was dazu fürht das die genutzen thrads über die lauzet imer weniger werden und so nicht mehr die gesamte Hardware ausnutzen.
    Das sieht man auch wuder bar am Strong Scaling, dort sihet man das Qiksort bei dieser lsite imernoch an Perfomece zunimt obwohl die Trahdanzel die anzahl an logischn Przesoren übersteigt. Wo hingen man bei Mergsort sihet das es nur leicht schlechter als die Tehortisch zu erwartene lauzeit verbeung ist.
}
