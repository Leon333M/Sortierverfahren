...
\newcommand{\EinflussDesDatentypsMessziel}{
    Hier wird die Zeit gemessen, die zum Sortieren von Strings benoetigt wird, da dies auch ein realitaetsnaher Anwendungsfall ist.
}
% \subsection{Erwartung}
\newcommand{\EinflussDesDatentypsErwartung}{
    Ich erwarte, dass das Sortieren länger dauert als bei \texttt{int}, da ein String wesentlich aufwaendiger zu vergleichen ist, weil dieser aus mehreren Zeichen (\texttt{char}) besteht und somit auch mehr Speicher benoetigt.
    ...
    Dies sollte wiederum dazu fuehren, dass die Graphen im Strong Scaling und Weak Scaling besser abschchneiden.
}
% \subsection{Diagramm}
