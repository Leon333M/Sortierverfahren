...
\newcommand{\GrundlegendeLaufzeitenAbhaengigVonDerArraygroesseDiagramm}{
    \begin{minipage}{0.5\linewidth}
        ...
        \captionof{figure}[Länge verdoppeln]{Länge verdoppeln}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Länge vergrößern]{Länge vergrößern}
...
\newcommand{\EinflussDesListentypsAnalyse}{
    Die gemessenen Daten zeigen deutlich, dass die reale Laufzeit im Best-Case unterhalb der Referenzfunktion \(n \log_2(n)\) liegt, was auf einen vorteilhaften konstanten Faktor von ca. 0,25 zurückzuführen ist.
    ...
    In der Debug-Version (ohne Compiler-Optimierungen) wurde bei einem sortierten Array der Größe von 400~Millionen Elementen hingegen eine Laufzeit von 14~s für Quicksort gemessen, welche oberhalb der berechneten Werte von \(n \log_2(n)\) liegt.
...
\newcommand{\TiefenbasierteThreadErzeugungDiagramm}{
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Strong Scaling (Tiefenbasierte Thread-Erzeugung)]{Strong Scaling (Tiefenbasierte Thread-Erzeugung)}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Weak Scaling (Tiefenbasierte Thread-Erzeugung)]{Weak Scaling (Tiefenbasierte Thread-Erzeugung)}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Länge vergrößern (Tiefenbasierte  Thread-Erzeugung)]{Länge vergrößern (Tiefenbasierte Thread-Erzeugung)}
...
\newcommand{\WorkerthreadsMessziel}{
    ...
    In der Praxis würde man die Threads weiterverwenden, wodurch dieser Overhead geringer ausfallen würde, aber ein gemeinsamer Thread-Pool für verschiedene Algorithmen würde den Rahmen dieser Arbeit sprengen.
    \newline
...
\newcommand{\WorkerthreadsDiagramm}{
    \begin{minipage}{\linewidth}
        \centering
        \initZeitenDiagrammA
        \captionof{figure}[Laufzeit der Sortierverfahren bei einer Arraygröße von 16 Elementen]{Laufzeit der Sortierverfahren bei einer Arraygröße von 16 Elementen}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Strong Scaling (Worker-Thread)]{Strong Scaling (Worker-Thread)}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Weak Scaling (Worker-Thread)]{Weak Scaling (Worker-Thread)}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Länge vergrößern (Worker-Thread)]{Länge vergrößern Worker-Thread}
...
\newcommand{\EinflussDesDatentypsDiagramm}{
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Strong Scaling String]{Strong Scaling String: [Beschreibung]}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Weak Scaling String]{Weak Scaling String: [Beschreibung]}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[Länge vergrößern String]{Länge vergrößern String: [Beschreibung]}
