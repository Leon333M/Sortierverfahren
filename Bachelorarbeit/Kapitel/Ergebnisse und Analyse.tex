...
\newcommand{\WorkerthreadsErwartung}{
    ...
    Dazu wird für die Mergesort Worker-Thread-Variante erwartet das es eine zu eine laufzet verbeung komt bis 32 thads erzugt wreden.
    Dies liegt an dem Wait und wird nur durch addTaskSmart kompensiert, indem die Funktion dafür sorgt, dass immer mindestens die Hälfte aller Threads ausgelastet bleibt.
    \newline
