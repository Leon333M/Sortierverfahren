...
\newcommand{\TiefenbasierteThreadErzeugungMessziel}{
    Hier bei mesen wir die rekusove varinate die einen der beiden rekusiven selbst aufrufe in ein neuen thrad ausführt.
    Dabei gibt es aber ein limit da jeder thrad selbst speicher bracuh und der RAM nicht unendlich große ist.
    Hirbei soll gemesen werden welchen perfomance unterschid mehr thrads machen.
}
% \subsection{Erwartung}
\newcommand{\TiefenbasierteThreadErzeugungErwartung}{
    Ich erwarte ein therosch liniaren perfomache zuwachs, solange kein hardware limti dazuschen komt.
    Dazu erwarte in diser variante das mergsort beser sklairt als qiksort. Da qiksort nicht exakt die lsite in der mite teilt, sodnern dis nur tehorisch im duschnit macht. Aber der bestcase von qiksort solte imer noch wesetloch besre sien al der von mergsort da in disen fall auf qiskort imer die lsite perfekt in der mitte tielt.
}
% \subsection{Diagramm}
