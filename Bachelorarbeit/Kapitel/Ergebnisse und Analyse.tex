...
\newcommand{\TiefenbasierteThreadErzeugungAnalyse}{
    entgegen der erwarteung mese ich kein relevanten unterschod ischen einer sorteirten und einer fastsorterten liste. vermutlich ligt das an der kompier optimirung da wie ja sowie schon unter der erwartetn lauzet von \(n log_2(n)\) sind.
    ICh mese aber deutliche permoomace verbesung in allen anderen berecihen.
}
