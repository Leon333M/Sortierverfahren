...
\newcommand{\EinflussDesDatentypsDiagramm}{
    ...
    \stepcounter{figure}% Erhöht die Nummer
    \edef\@currentlabel{\thefigure}% Setzt die Nummer für das Label fest
    \label{fig:datentypB}% Jetzt kannst du \ref{fig:datentypB} nutzen
    \addcontentsline{lof}{figure}{Abbildung \thefigure: Einfluss Datentyp B}%
    \newline
