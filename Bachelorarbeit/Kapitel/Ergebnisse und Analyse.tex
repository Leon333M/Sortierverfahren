...
\newcommand{\EinflussDesDatentypsDiagramm}{
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}{EinflussDesDatentyps B: [Beschreibung]}
        \label{fig:datentypB}
    \end{minipage}
    \newline
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}{EinflussDesDatentyps C: [Beschreibung]}
        \label{fig:datentypC}
    \end{minipage}
    \newline
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}{EinflussDesDatentyps A: [Beschreibung]}
        \label{fig:datentypA}
    \end{minipage}
}
