...
\newcommand{\EinflussDesDatentypsDiagramm}{
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[EinflussDesDatentyps B]{EinflussDesDatentyps B: [Beschreibung]}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[EinflussDesDatentyps C]{EinflussDesDatentyps C: [Beschreibung]}
    ...
    \begin{minipage}{\linewidth}
        ...
        \captionof{figure}[EinflussDesDatentyps A]{EinflussDesDatentyps A: [Beschreibung]}
...
\newcommand{\EinflussDesDatentypsAnalyse}{
    % wie in Abbildung~\ref{fig:datentypB} dargestellt, ...
