...
\newcommand{\WorkerthreadsAbildung}{
    \begin{tikzpicture}[
        ...
        % Worker-Threads
        \node[thread, below left=3cm and 1cm of queue] (w1) {Worker-Thread 1};
        \node[thread, below=3cm of queue] (w2) {Worker-Thread 2};
        \node[thread, below right=3cm and 1cm of queue] (w3) {Worker-Thread 3};

        % Die Pfeile mit dem neuen Stil "pfeil"
