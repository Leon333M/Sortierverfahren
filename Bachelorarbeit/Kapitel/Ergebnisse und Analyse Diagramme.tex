...
\newcommand{\QuicksortMaxArrayVerdoppelnMesswerteWorstcase}{%
    \addplot[red!60!black, mark=*] coordinates {
            (25000000,165043900)
            (50000000,340924200)
            (100000000,726211400)
            (200000000,1550396900)
    ...
    \addlegendentry{Quicksort Worstcase}
}
...
\newcommand{\EinflussDesListentypsDiagrammB}{%
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \QuicksortMaxArrayVerdoppelnMesswerte
            \QuicksortMaxArrayVerdoppelnMesswerteSortiert
            \QuicksortMaxArrayVerdoppelnMesswerteWorstcase
            % n*log2(n)
            \addplot[black, dashed,domain=1e7:4e8, samples=100] {x*log2(x)};
            \addlegendentry{$n \cdot \log_2 n$}
        \end{axis}
...
\newcommand{\EinflussDesListentypsDiagrammC}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                log basis x=10,
                %xtick=data,
                xtick={1,2,4,8,16,100,1000,2000,4000,8000,20000,40000,80000,200000,400000,800000},
                xticklabels={
                        $1$,$2$,$4$,$8$,$16$,
                        $100$,$1k$,
                        $2k$,$4k$,$8k$,
                ...
                ymode=log,
                log basis y=10,
                ytick={1,10,10^2,10^3,10^4,10^5,10^6,10^7,10^8,10^9,10^10},
