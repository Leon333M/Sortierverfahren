...
\newcommand{\MergesortInvertSortiertG}{%
    \addplot[orange, mark=*] coordinates {
            ...
            (40000000,2673012400)
            (50000000,3271536200)
            (100000000,6769590300)
            (200000000,14040508000)
            (400000000,28393058600)
        };
    \addlegendentry{Mergesort InvertSortiert}
}

\newcommand{\QuicksortInvertSortiertG}{%
    \addplot[yellow, mark=*] coordinates {
            ...
            (50000000,360331100)
            (100000000,755201900)
            (200000000,1558540900)
            (400000000,3167230400)
        };
    \addlegendentry{Quicksort InvertSortiert}
}
...
\newcommand{\EinflussDesListentypsDiagrammC}{%
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \MergesortgSortiertG
            \QuicksortSortiertG
            \MergesortInvertSortiertG
            \QuicksortInvertSortiertG
            % n*log2(n)
