...
\newcommand{\QuicksortSortiertGWorstCase}{%
    % pivo = liste[rechts];
    ...
    \addlegendentry{Quicksort Worst Case}
}

\newcommand{\QuicksortSortiertWWorstCase}{%
    % pivo = liste[rechts];
    \addplot[red, mark=*] coordinates {
            (1,613800)
            (2,87700)
    ...
    \addlegendentry{Quicksort WT1 Worst Case}
}
...
\newcommand{\QuicksortStringSortiertGWorstCase}{%
    % pivo = liste[rechts];
    \addplot[red, mark=*] coordinates {
            (1,100)
            (4,400)
...
\newcommand{\QuicksortStringSortiertWWorstCase}{%
    % pivo = liste[rechts];
    \addplot[red, mark=*] coordinates {
            (1,926300)
            (2,120200)
...
\newcommand{\QuicksortZufallWeakScaling}{%
    ...
    \addlegendentry{Quicksort T Zufall}
}
...
\newcommand{\TheorieWeakScaling}[1]{%
    ...
    % \addlegendentry{Theoretische Laufzeit ($\times \text{#1}$)}
    \addlegendentry{$ #1 \cdot T(n,p) $}
}
...
\newcommand{\GrundlegendeLaufzeitenAbhaengigVonDerArraygroesseDiagrammA}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Array-Länge},
                ylabel={Dauer in ns},
                title={Laufzeit der Sortierverfahren},
                xmin=0, xmax=4 * 10^8,
                ymin=0, ymax=6*10^10,
                grid=both,
                grid style=dashed,
...
\newcommand{\GrundlegendeLaufzeitenAbhaengigVonDerArraygroesseDiagrammB}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Array-Länge},
                ylabel={Dauer in ns},
                title={Laufzeit der Sortierverfahren (logarithmische Achsen)},
...
\newcommand{\GrundlegendeLaufzeitenAbhaengigVonDerArraygroesseDiagrammC}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Array-Länge},
                ylabel={Dauer in ns},
                title={Grundlegende Laufzeit der Sortierverfahren, logarithmische Achsen},
                xmin=1, xmax=800000,
...
\newcommand{\EinflussDesListentypsDiagrammA}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Array-Länge},
                ylabel={Dauer in ns},
                title={Laufzeit der Sortierverfahren (Arraygröße 1 - 400M)},
                xmin=0, xmax=4 * 10^8,
                ymin=0, ymax=6*10^10,
                grid=both,
                grid style=dashed,
                legend pos=north west,
                ytick={0.5*10^10, 1*10^10, 1.5*10^10, 2*10^10, 2.5*10^10, 3*10^10, 3.5*10^10, 4*10^10, 4.5*10^10, 5*10^10, 5.5*10^10, 6*10^10},
                % xtick={2^21,2^23,2^24,2^25},
                % xticklabels={$2^{21}$, $2^{23}$, $2^{24}$, $2^{25}$},
                % scaled x ticks=false,
                % scaled y ticks=false,
...
\newcommand{\EinflussDesListentypsDiagrammB}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Array-Länge},
                ylabel={Dauer in ns},
                title={Laufzeit der Sortierverfahren (Arraygröße 25M - 400M, logarithmische Achsen)},
                xmin=2.5*10^7, xmax=4*10^8,
                ymin=10^7, ymax=1*10^11,
                grid=both,
                grid style=dashed,
                legend pos=south east,
                ...
                ymode=log,
                log basis y=10,
                ytick={1*10^8, 1*10^9, 1*10^10, 1*10^11},
                % xtick={2^21,2^23,2^24,2^25},
                % xticklabels={$2^{21}$, $2^{23}$, $2^{24}$, $2^{25}$},
                % scaled x ticks=false,
                % scaled y ticks=false,
...
\newcommand{\TiefenbasierteThreadErzeugungDiagrammB}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                ylabel={Dauer in ns},
                title={Strong Scaling: Laufzeit bei Arraygröße $400M$}, % Threads verdoppeln, Länge konstat, Strong Scaling
                xmin=1, xmax=2^14,
...
\newcommand{\TiefenbasierteThreadErzeugungDiagrammC}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Thread-Anzahl},
                ylabel={Dauer in ns},
                title={Weak Scaling {\small (Start-Arraygröße $2.5 \cdot {10^7}$)}}, % Threads und Länge verdoppeln
                xmin=1, xmax=16,
...
\newcommand{\EinflussDesDatentypsDiagrammA}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Array-Länge},
                ylabel={Dauer in ns},
                title={Laufzeit der Sortierverfahren (Arraygröße 1 - 80M)},
            ...
            \QuicksortStringSortiertWWorstCase
            % n*log2(n)
            \addplot[black, dashed,domain=1:400000000, samples=1000] {x*log2(x)};
            \addlegendentry{$n \cdot \log_2 n$}
            % n^2
...
\newcommand{\EinflussDesDatentypsDiagrammB}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Thread-Anzahl},
                ylabel={Dauer in ns},
                title={Strong Scaling: Laufzeit bei Arraygröße $40M$}, % Threads verdoppeln, Länge konstat, Strong Scaling
                xmin=1, xmax=16384,
...
\newcommand{\EinflussDesDatentypsDiagrammC}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Thread-Anzahl},
                ylabel={Dauer in ns},
                title={Weak Scaling {\small (Start-Arraygröße $2.5 \cdot {10^6}$)}}, % Threads und Länge verdoppeln
                xmin=1, xmax=16,
...
\newcommand{\initZeitenDiagrammA}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                xlabel={Thread-Anzahl},
                ylabel={Dauer in ns},
                title={Laufzeit der Sortierverfahren bei einer Arraygröße von 16 Elementen},
                grid=both,
                grid style=dashed,
                xmin=1, xmax=2^14,
...
\newcommand{\WorkerthreadsAbildung}{
    \begin{tikzpicture}[
        every node/.style={draw, minimum width=2cm, minimum height=0.8cm, align=center},
        thread/.style={draw, rectangle, fill=blue!20, minimum width=2cm, minimum height=0.8cm},
        pfeil/.style={{Stealth[scale=1]}-{Stealth[scale=1]}, thick}
        ]

        % Gemeinsame Queue
        \node[draw, rectangle, minimum width=6cm, minimum height=2cm] (queue) {Gemeinsame Aufgaben-Queue\\(Task-Queue)};

        % Worker-Threads horizontal verteilt
        \node[thread, below=3cm of queue, xshift=-5cm] (w1) {Worker-Thread 1};
        \node[thread, below=3cm of queue, xshift=0cm]  (w2) {Worker-Thread 2};
        \node[thread, below=3cm of queue, xshift=5cm]  (w3) {Worker-Thread 3};

        % Pfeile
        \draw[pfeil] (queue.south west) -- (w1.north);
        \draw[pfeil] (queue.south)      -- (w2.north);
        \draw[pfeil] (queue.south east) -- (w3.north);

    \end{tikzpicture}
}

\newcommand{\QuicksortWPZufallStrongScaling}{%
    % 400M
    \addplot[violet, mark=*] coordinates {
            (1,28593774500)
            (2,14402012400)
            (4,7465069500)
            (8,4142233700)
    ...
    \addlegendentry{Quicksort WTP Zufall}
}

\newcommand{\QuicksortWPZufallWeakScaling}{%
    % Threads und Lange verdoppeln
    \addplot[violet, mark=*] coordinates {
            (1,1558438200)
            (2,1652901400)
            (4,1782584900)
...
\newcommand{\WorkerthreadsWPDiagrammB}{%
    \begin{tikzpicture}
        \begin{axis}[
                title style={yshift=1.5ex},
                width=1\textwidth,
            ...
            \TheorieStrongScaling{400000000}{5}
            \TheorieStrongScaling{400000000}{2.5}
            \QuicksortWPZufallStrongScaling
            \addplot [
                domain=1:16,
                samples=5,
                color=black,
                dashed
            ] { (2.5 * (400000000 * ln(400000000)/ln(2) + 400000000)) / x };
            \addlegendentry{$2.5 \cdot (1/p) \cdot (n \cdot log_2(n) + n))$}
        \end{axis}
    \end{tikzpicture}%
}


\newcommand{\WorkerthreadsWPDiagrammC}{%
    \begin{tikzpicture}
        \begin{axis}[
                title style={yshift=1.5ex},
                width=1\textwidth,
                ...
                % ymode=log,
                % log basis y=10,
                ytick={0.1*10^10,0.15*10^10,0.2*10^10,0.25*10^10,0.3*10^10,0.35*10^10,0.4*10^10,0.5*10^10,0.6*10^10,0.7*10^10,0.8*10^10,0.9*10^10,1*10^10,1.1*10^10},
                % scaled x ticks=false,
                % scaled y ticks=false,
            ]
            \MergesortWZufallWeakScaling
            ...
            \TheorieWeakScaling{5}
            \TheorieWeakScaling{2.5}
            \QuicksortWPZufallWeakScaling
            \addplot [
                color=black,
                domain=1:16,
                dashed
            ] { 2.5 * ((1/x) * ((x * 2.5*10^7) * log2(x * 2.5*10^7) + (x * 2.5*10^7))) };
            \addlegendentry{$2.5 \cdot (1/p) \cdot (n \cdot log_2(n) + n))$}
        \end{axis}
    \end{tikzpicture}%
}