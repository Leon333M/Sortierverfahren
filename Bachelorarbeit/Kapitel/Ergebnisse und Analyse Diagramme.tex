...
\newcommand{\MergesortZufallSechzehnWorkerThreads}{%
    \addplot[orange, mark=*] coordinates {
            ...
            (40000000,888789800)
            (50000000,1204652300)
            (100000000,2379348500)
            (200000000,5217021800)
            (400000000,9551264300)
        };
...
\newcommand{\MergesortSortiertSechzehnWorkerThreads}{%
    \addplot[blue!60!black, mark=*] coordinates {
            ...
            (40000000,565738600)
            (50000000,793015400)
            (100000000,1504939700)
            (200000000,3105189300)
            (400000000,6500211900)
        };
...
\newcommand{\TheorieStrongScaling}{%
    \pgfmathsetmacro{\n}{400000000}
    \pgfmathsetmacro{\faktor}{2.5}
    \addplot[
        black,
        dashed,
        domain=1:2^14,
    ...
    \addlegendentry{Theorie (um  $\times \faktor$ skaliert)}
}
...
\newcommand{\TiefenbasierteThreadErzeugungDiagrammB}{%
    \begin{tikzpicture}
        \begin{axis}[
                ...
                % ymode=log,
                % log basis y=10,
                ytick={10^9,0.5*10^10,1*10^10,1.5*10^10,2*10^10,2.5*10^10,3*10^10,3.5*10^10,4*10^10},
                % scaled x ticks=false,
                % scaled y ticks=false,
            ]
