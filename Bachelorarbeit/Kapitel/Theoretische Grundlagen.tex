...
\newcommand{\GrundlagenDerParallelisierung}{
    ...
    \cite{Weinzierl2024}
    Die fomel beschreibt jedoch nur ein lineras sklainen mit thrads.
    Da dies aber bei den von mir implemterten vrainten nicht der fal,
    Weswegen ich meine einge T(n,p) nutze,
    und nicht weiter auf das exakte Amdahlsche Gesetz eingehe.
}
