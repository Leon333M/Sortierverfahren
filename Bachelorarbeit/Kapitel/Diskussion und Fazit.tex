...
\newcommand{\Zusammenfassung}{
    Zusammenfassend lässt sich sagen, dass die Quicksort-Worker-Stealing-Variante allgemein der tiefenbasierten Thread-Erzeugungsvariante von Mergesort überlegen ist.
    Allerdings sollte man darauf achten, erst dann von der seriellen Version auf die Parallelisierung umzuschalten, wenn die entsprechende Mindestlaufzeit bzw. Mindest-Array-Größe erreicht ist.
    Zudem habe ich gezeigt, dass die theoretisch mögliche Laufzeitverbesserung fast erreicht wird.
    Es hat sich ebenso herausgestellt, dass Compiler-Optimierungen einen erheblichen Einfluss auf die Laufzeit haben, vor allem wenn es um Threads geht, auch wenn ich in dieser Arbeit nicht explizit darauf eingegangen bin.
    Zudem ist noch viel Verbesserungspotenzial vorhanden, wie ich bereits im Ausblick erläutert habe.
}
