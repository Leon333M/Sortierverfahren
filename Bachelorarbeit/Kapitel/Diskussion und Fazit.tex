...
\newcommand{\BeantwortungDerForschungsfrage}{
    Von den von mir prgrameirten varainten besitzt ganz klar die Quicksort Worker-Stealing vainte die beste lauziet,
    uter der bedingun das das zu sortirdne int aray midestens 20k groß ist. bzw. das string aray midestens 8k groß ist.
    Erst wen die sher unwarschinlice worscse lauziet untolerribar ist, ist die Mergsort Tiefenbasierte Thread-Erzeugung die bessere wahl.
    Dies bitet aber erst eine besre lauzeit wenn das zu sortiedne int Aray midestens 8k große ist. bzw. das string Aray midestens 4k große ist. Wen das zu sortiedne Aray jedoch keiner ist, ist die serile varinte zu bevozugen da dise in disen berech schnerl ferting ist. Dis ist auf die anfgs genaten Overhads zurückzuführen.
}
