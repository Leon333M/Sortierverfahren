...
\newcommand{\Ausblick}{
    ...
    \newline.
    Das pefkete Pivo elment ist der Median der zu partionirenden lsite.
    Alerding kan man den medin nur betimnen indem man die Ksite sorteirt,
    weswegen es sinlos ist es perfkt zu bestimen.
    \newline
