Formelnotizen:
Dies sind nur Notizen für die Herleitung und enthalten daher haufenweise Fehler.
...
e sind die anzahl ebenen die paralleisiert laufen (anzahl Threads t = 2^e)
T(n,e) = n * 2 ( 1 - 1 / ( 2 ^ e ) ) + (n/2^e)*log2( (n/2^e)) + (n/2^e)
O(T(n,e)) = O(n+(n/2^e)*log2(n))
T(n, unendlich) = 2*n

Theoretisch wenn mischen / partitioniere parallel auf unendlich viel Threads ist dann hat man:
T(n, unendlich) = 2*n/unendlich = 0
O(T(n, unendlich)) = 0
