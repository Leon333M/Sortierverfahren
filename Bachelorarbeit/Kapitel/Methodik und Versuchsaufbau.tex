...
% \section{Optimirung}
\newcommand{\Optimirung}{
    Auf eine optimug des codes wurde bewsut verzichtet da es vorgeing um den verglcih der Thdading startegien geht
    und eine perfkte impelritng zu zeitaufädig gewesen wäre.
    Da das raus optimren des waits der (Worker-Thread-Variante Mergesort ,lst:mergesortW) Varinte voiel zu aufädig wäre. und acuih kein einfaces beispie dan mer sit. Daher wurde glecih vostädign auf eine optimuig verzichte da ich damit nicht ale vainten glecihmäsig mer potimren konte.
}