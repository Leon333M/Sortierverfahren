...
\newcommand{\Implementierungsvarianten}{
    ...
    Natürlich unterscheiden sich die Average-Case-Laufzeiten beider Varianten in der Praxis dramatisch. Für diese Arbeit ist es jedoch ausreichend, nur den \textbf{heuristischen Average-Case} zu analysieren.
    \newline
