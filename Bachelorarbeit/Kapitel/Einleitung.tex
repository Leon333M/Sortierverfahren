...
\newcommand{\InkrementArrayText}{
    Aa hand disesn eifachen beipis möchte ich zeigen was paralisung in der parxis bingt und das die praxis nicht imer mit den erwartungen übereistmit. Dazu komr sit das dis ein einfacehs beiiel ist um besser in das thma paralisirung einzusteigen.
    An den Digramen kan man deutlich sehen das disen beipiel nicht liniar mit der thads anzahl skaliert, obwhol es reintehoritshc so soin solte. Das ligt warscdhinlich daran das wir am Daten übertragslimit sind. Das würde erklären warum ab ein gweisen punkt, mehr ausgelaste kerne kein perfomece gewin mer bringen. Dazu siht man auch das das zu erhönte Aray midsets 2^20 groß sien muss damit überhaupt irgend mit irgedeiner thad anzalh dopelt so schnell ist wie die sereli Lauzeit. Ich möchte aber auch erwänen das normaleweise die Serili laufzeit von diser funktoin immer wengier als 100ns ist. Dies ligt an der Compier optimirung. Daher habe ich dsie funktion mit volatile asugefürt was verhidert das der compier die eigntliche aufgabe rasuoptimert damit sich sie messen kan. Das volatile sorgt dafür das bei jeden lese vorgag die daten immer aus den ram gelden werden müssen. Dhaer sit es auch das waschlcihte szearaio das unser beispiel an Datenraten limit ist. Dazu komt das die eigliche aufgabe trivial für die cpu ist und somit dise garnicht volständig auslastet.
}
